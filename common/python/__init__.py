...
class Backend(IntEnum):
    ...
    def get(task_config_json):
        ...
        # print(conf_utils.get_comm_config(consts.COMM_CONF_KEY_BACKEND), task_config_json['job']['env']['backend'])
        # print(backend, conf_utils.get_backend_from_string(
        #     task_config_json['job']['env']['backend']
        # ))
        # backend = int(backend) if backend else conf_utils.get_backend_from_string(
        #     task_config_json['job']['env']['backend']
        # )
        if backend is None:  # yby
            backend = conf_utils.get_backend_from_string(task_config_json['job']['env']['backend'])
