...
class Binning(object):
    ...
    def convert_feature_to_bin(self, data_instances, split_points=None):
        ...
        # LOGGER.info("============new_data============{}".format(new_data.take(600)))

        # LOGGER.info("==============split_points_result=========={}".format(split_points_result))

        # n_t = new_data.take(600)
        # for i in range(100):
        #     bin_id = n_t[i][1].features.get_sparse_vector()
        #     LOGGER.info("============bin_id============{}".format(bin_id))
