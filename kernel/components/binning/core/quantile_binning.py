...
from kernel.components.binning.core.quantile_summaries import quantile_summary_factory
from kernel.components.binning.vertfeaturebinning.param import FeatureBinningParam
from kernel.utils import data_util, consts
...
class QuantileBinning(Binning):
    ...
    @staticmethod
    def feature_summary_v2(data_iter, params, cols_dict, abnormal_list, header, is_sparse):
        summary_dict = {}
...
class QuantileBinningTool(QuantileBinning):
    ...
    def fit_summary(self, data_instances, is_sparse=None):
        ...
        f = functools.partial(self.feature_summary_v2,
                              params=self.params,
                              abnormal_list=self.abnormal_list,
                              cols_dict=self.bin_inner_param.bin_cols_map,
                              header=self.header,
