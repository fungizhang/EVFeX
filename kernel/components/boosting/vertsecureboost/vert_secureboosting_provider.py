...
class VertSecureBoostingProvider(BoostingTree):
    ...
    def fit(self, data_inst, validate_data=None):
        ...
        # LOGGER.info("=============data_inst====111======={}".format(data_inst.take(100)))
        #
        # n_t = data_inst.take(600)
        # for i in range(100):
        #     bin_id = n_t[i][1].features
        #     LOGGER.info("============bin_id=====1======={}".format(bin_id))
        ...
        # for i in range(100):
        #     bin_id = n_t[i][1].features
        #     LOGGER.info("============bin_id=======2====={}".format(bin_id))
        ...
        # n_t = data_inst.take(600)
        # for i in range(100):
        #     bin_id = n_t[i][1].features.get_sparse_vector()
        #     LOGGER.info("============bin_id=======2====={}".format(bin_id))
