...
from kernel.transfer.variables.transfer_class.vert_smm_decision_tree_transfer_variable import \
    VertSmmDecisionTreeTransferVariable         #tby
...
class VertDecisionTreePromoter(DecisionTree):
    def __init__(self, tree_param):
        ...
        self.transfer_inst = VertSmmDecisionTreeTransferVariable()
    ...
    def masked_grad_hess(self, grad_hess):
        ...
        ori_about_num = gossed_num * math.ceil(1 / (self.top_rate + self.other_rate * (1-self.top_rate)))
        ...
        result_needed = tmp_obj1.join(grad_hess, lambda x1, x2: x1)
    ...
    def compute_best_splits2_zfj(self, node_map, dep, batch_idx, xgb_g_h):
        ...
        for provider_idx, split_info_table in enumerate(provider_split_info_tables):
            ...
            provider_split_info = self.splitter.find_provider_best_split_info_smm(split_info_table,
