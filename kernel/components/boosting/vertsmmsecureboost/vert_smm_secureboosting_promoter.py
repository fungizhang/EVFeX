...
from kernel.components.boosting.vertsmmsecureboost.vert_smm_decision_tree_promoter import VertDecisionTreePromoter  #tby
...
from kernel.transfer.variables.transfer_class.vert_smm_secure_boost_transfer_variable import \
    VertSmmSecureBoostingTransferVariable  #tby
...
class VertSmmSecureBoostingPromoter(BoostingTree):
    def __init__(self):
        super(VertSmmSecureBoostingPromoter, self).__init__()
        ...
        self.transfer_variable = VertSmmSecureBoostingTransferVariable()
    ...
    def _init_model(self, param: VertSecureBoostParam):
        super(VertSmmSecureBoostingPromoter, self)._init_model(param)
    ...
    def traverse_trees(node_pos, sample, trees: List[VertDecisionTreePromoter]):
        ...
        for t_idx, tree in enumerate(trees):
            ...
            rs, reach_leaf = VertSmmSecureBoostingPromoter.traverse_a_tree(tree, sample, cur_node_idx)
    ...
    def get_predict_scores(leaf_pos, learning_rate, init_score, trees: List[VertDecisionTreePromoter]
        ...
        predict_func = functools.partial(VertSmmSecureBoostingPromoter.add_y_hat,
    ...
    def fit(self, data_inst, validate_data=None):
        ...
        LOGGER.info("==========train secureboosting promoter model=============={}".format(execution_time))
