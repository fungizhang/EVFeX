...
from kernel.components.boosting.vertsmmsecureboost.vert_smm_decision_tree_provider import VertDecisionTreeProvider
...
class VertSmmSecureBoostingProvider(BoostingTree):
    def __init__(self):
        super(VertSmmSecureBoostingProvider, self).__init__()
    ...
    def _init_model(self, param: VertSecureBoostParam):
        ...
        super(VertSmmSecureBoostingProvider, self)._init_model(param)
    ...
    def check_run_sp_opt(self):
        ...
        if self.run_sparse_opt and not self.has_transformed_data:
            ...
            sparse_to_array = functools.partial(
                VertSmmSecureBoostingProvider.sparse_to_array,
    ...
    def fit(self, data_inst, validate_data=None):
        ...
        LOGGER.info("==========train secureboosting provider model=============={}".format(execution_time))
    ...
    def traverse_trees(leaf_pos, sample, trees: List[VertDecisionTreeProvider]):
        ...
        for t_idx, tree in enumerate(trees):
            ...
            if cur_node_idx == -1:
                continue
            nid, _ = VertSmmSecureBoostingProvider.traverse_a_tree(tree, sample, cur_node_idx)
