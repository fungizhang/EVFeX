...
from kernel.components.linr.linr_model_weight import LinRModelWeights as LinearRegressionWeights
...
from kernel.protobuf.generated import lr_model_param_pb2  # need to edit
...
class BaseLinRModel(ModelBase):
    def __init__(self):
        super(BaseLinRModel, self).__init__()
        # attribute:
        self.n_iter_ = 0
        self.classes_ = None
    ...
    def _init_model(self, params):
        ...
        self.eval_type = params.eval_type #yby
    ...
    def parse_single_model_param(self, model_weights: LinearRegressionWeights, header):
        weight_dict = {}
        LOGGER.debug("in get_single_model_param, model_weights: {}, coef: {}, header: {}".format(
    ...
    def parse_param(self, model_weights, header):
        ...
        param_protobuf_obj = lr_model_param_pb2.LRModelParam(**single_result)   # need to edit
    ...
    def get_metrics_param(self):
        return EvaluateParam(
            eval_type=self.eval_type, metrics=self.metrics  # regression 交叉验证时应该写死
        ) 
    ...
    def load_single_model(self, single_model_obj):
        ...
        self.model_weights = LinearRegressionWeights(tmp_vars, fit_intercept=self.fit_intercept)
        return self
