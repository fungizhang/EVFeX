...
from kernel.components.linr.param import VertLinearParam #tby

from kernel.protobuf.generated import lr_model_meta_pb2  # need to edit
from kernel.security import PaillierEncrypt
from kernel.transfer.variables.transfer_class.vert_linr_transfer_variable import VertLinRTransferVariable #新增
from kernel.utils import consts

LOGGER = log_utils.get_logger()


class VertLinRBaseModel(BaseLinRModel):
    def __init__(self):
        super().__init__()
        self.model_name = 'VertLinearRegression'
        self.model_param_name = 'VertLinearRegressionParam'
        self.model_meta_name = 'VertLinearRegressionMeta'
        ...
        self.model_param = VertLinearParam()
    ...
    def _init_model(self, params):
        ...
        self.transfer_variable = VertLinRTransferVariable()
