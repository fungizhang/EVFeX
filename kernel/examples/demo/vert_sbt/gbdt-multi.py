...
def main(config="../../config.yaml", param="./multi_config.yaml"):
    ...
    # prepare data
    df_promoter = pd.read_csv(os.path.join(r'C:\Users\zhangfangjiao\Desktop\WeFe-main\kernel\examples\data', data_promoter), index_col=idx)
    df_provider = pd.read_csv(os.path.join(r'C:\Users\zhangfangjiao\Desktop\WeFe-main\kernel\examples\data', data_provider), index_col=idx)
